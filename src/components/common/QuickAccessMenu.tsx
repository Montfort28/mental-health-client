    ...
    const quickActions: QuickAction[] = [
        ...
        <>
            ...
            <div className="fixed bottom-6 right-6 z-50">
                ...
                <motion.button
                    className="bg-gradient-to-r from-teal-400 to-blue-500 text-white rounded-full p-4 shadow-lg hover:shadow-xl transform transition-transform hover:scale-105"
                    whileTap={{ scale: 0.95 }}
