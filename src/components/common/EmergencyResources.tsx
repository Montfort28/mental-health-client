...
import { FiX, FiPhone, FiGlobe, FiMessageCircle, FiHeart } from 'react-icons/fi';
                ...
                >
                    ...
                    >
                        ...
                        <div className="text-center mb-6">
                            <FiHeart className="w-12 h-12 text-red-500 mx-auto mb-2" />
                        ...
                        <section className="mb-6">
                            <h3 className="text-lg font-semibold text-blue-600 mb-3 flex items-center">
                                <FiMessageCircle className="mr-2" /> Support Helplines
                            </h3>
                        ...
                        <section>
                            <h3 className="text-lg font-semibold text-green-600 mb-3 flex items-center">
                                <FiGlobe className="mr-2" /> Online Resources
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
