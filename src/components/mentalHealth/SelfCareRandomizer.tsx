...
import { FiShuffle, FiHeart, FiSun, FiCoffee, FiMusic, FiBook, FiPhone, FiActivity, FiCloud, FiPenTool, FiUser, FiSmile, FiCheck } from 'react-icons/fi';
    ...
    return (
        <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            ${isAnimating ? 'opacity-75 cursor-not-allowed' : ''}`}
                >
                    <FiShuffle className={`w-5 h-5 ${isAnimating ? 'animate-spin' : ''}`} />
