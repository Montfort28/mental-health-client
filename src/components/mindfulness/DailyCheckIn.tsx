...
import { FiX, FiSmile, FiSun, FiMoon, FiHeart } from 'react-icons/fi';
...
const moodOptions: MoodOption[] = [
    { emoji: '😊', label: 'Great', value: 5, icon: <FiSmile className="text-green-500" /> },
    { emoji: '🙂', label: 'Good', value: 4, icon: <FiSmile className="text-blue-500" /> },
    { emoji: '😐', label: 'Okay', value: 3, icon: <FiSmile className="text-yellow-500" /> },
    { emoji: '😕', label: 'Not Great', value: 2, icon: <FiSmile className="text-orange-500" /> },
    { emoji: '😢', label: 'Struggling', value: 1, icon: <FiSmile className="text-red-500" /> }
];

const DailyCheckIn: React.FC<DailyCheckInProps> = ({ isOpen, onClose }): JSX.Element => {
