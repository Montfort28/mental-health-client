...
import { FiX, FiWind } from 'react-icons/fi';
...
const QuickBreathingExercise: React.FC<QuickBreathingExerciseProps> = ({ isOpen, onClose }): JSX.Element => {
                ...
                >
                    ...
                    >
                        ...
                        <div className="text-center">
                            <FiWind className="w-12 h-12 mx-auto text-blue-500 mb-4" />
