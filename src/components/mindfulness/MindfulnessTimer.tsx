...
import { FiX, FiPlay, FiPause, FiBell } from 'react-icons/fi';
...
const MindfulnessTimer: React.FC<MindfulnessTimerProps> = ({ isOpen, onClose }): JSX.Element => {
                ...
                >
                    ...
                    >
                        ...
                        <div className="text-center py-6">
                            ...
                            >
                                <FiBell className="w-5 h-5 inline-block mr-2" />
